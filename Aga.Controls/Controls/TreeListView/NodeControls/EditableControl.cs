...
namespace Quimron.WinUI.Controls.TreeListView.NodeControls
{
	public abstract class EditableControl : InteractiveControl
	{
		...
		private TreeListNode _editNode;
		protected TreeListNode EditNode
		{
		...
		protected abstract void DoApplyChanges(TreeListNode node, Control editor);

		protected abstract Control CreateEditor(TreeListNode node);
