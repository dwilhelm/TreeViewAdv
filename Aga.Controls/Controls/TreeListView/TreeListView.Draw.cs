...
namespace Quimron.WinUI.Controls.TreeListView
{
	public partial class TreeListView
	{
		...
		public void DrawNode(TreeListNode node, DrawContext context)
		{
		...
		private void DrawLines(Graphics gr, TreeListNode node, Rectangle rowRect)
		{
