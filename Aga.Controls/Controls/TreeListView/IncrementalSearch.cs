...
namespace Quimron.WinUI.Controls.TreeListView
{
	public class IncrementalSearch
	{
		...
		protected TreeListNode CurrentNode
		{
		...
		protected IEnumerable<string> IterateNodeLabels(TreeListNode start)
		{
			_currentNode = start;
		...
		private IEnumerable<string> GetNodeLabels(TreeListNode node)
		{
