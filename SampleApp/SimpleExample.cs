...
namespace SampleApp
{
	public partial class SimpleExample : UserControl
	{
		...
		{
			if (e.Data.GetDataPresent(typeof(TreeListNode[])) && _tree.DropPosition.Node != null)
			{
				TreeListNode[] nodes = e.Data.GetData(typeof(TreeListNode[])) as TreeListNode[];
				TreeListNode parent = _tree.DropPosition.Node;
		...
		private bool CheckNodeParent(TreeListNode parent, TreeListNode node)
		{
			while (parent != null)
			{
				if (node == parent)
		...
		private void _tree_DragDrop(object sender, DragEventArgs e)
		{
			...
			TreeListNode[] nodes = (TreeListNode[])e.Data.GetData(typeof(TreeListNode[]));
		...
		private void _tree_NodeMouseDoubleClick(object sender, TreeListNodeMouseEventArgs e)
		{
