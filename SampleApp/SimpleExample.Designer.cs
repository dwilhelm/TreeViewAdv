namespace SampleApp
{
	partial class SimpleExample
	{
		...
		private void InitializeComponent()
		{
			...
			this._tree = new Quimron.WinUI.Controls.TreeListView.TreeListView();
			this._nodeCheckBox = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeCheckBox();
			this._nodeStateIcon = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeStateIcon();
			this._nodeTextBox = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox();
			this._tree2 = new Quimron.WinUI.Controls.TreeListView.TreeListView();
			this.nodeTextBox1 = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox();
			...
			this._autoRowHeight.Location = new System.Drawing.Point(377, 336);
			...
			this._fontSize.Location = new System.Drawing.Point(437, 310);
			...
			this._performanceTest.Location = new System.Drawing.Point(377, 359);
			...
			this._tree.SelectionMode = Quimron.WinUI.Controls.TreeListView.TreeSelectionMode.MultiSameParent;
			this._tree.ShowNodeToolTips = true;
			this._tree.Size = new System.Drawing.Size(371, 223);
			this._tree.TabIndex = 0;
			this._tree.NodeMouseDoubleClick += new System.EventHandler<Quimron.WinUI.Controls.TreeListView.TreeListNodeMouseEventArgs>(this._tree_NodeMouseDoubleClick);
		...
		private Quimron.WinUI.Controls.TreeListView.TreeListView _tree;
		private System.Windows.Forms.Button _addRoot;
		private System.Windows.Forms.Button _clear;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeCheckBox _nodeCheckBox;
		private System.Windows.Forms.Button _addChild;
		private System.Windows.Forms.Button _deleteNode;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeStateIcon _nodeStateIcon;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox _nodeTextBox;
		...
		private Quimron.WinUI.Controls.TreeListView.TreeListView _tree2;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox nodeTextBox1;
