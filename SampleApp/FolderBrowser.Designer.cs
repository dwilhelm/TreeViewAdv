namespace SampleApp
{
	partial class FolderBrowser
	{
		...
		{
			this._treeView = new Quimron.WinUI.Controls.TreeListView.TreeListView();
			this.treeColumn1 = new Quimron.WinUI.Controls.TreeListView.TreeColumn();
			this.treeColumn2 = new Quimron.WinUI.Controls.TreeListView.TreeColumn();
			this.treeColumn3 = new Quimron.WinUI.Controls.TreeListView.TreeColumn();
			this.nodeCheckBox1 = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeCheckBox();
			this._icon = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeStateIcon();
			this._name = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox();
			this._size = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox();
			this._date = new Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox();
			this.SuspendLayout();
			// 
			// _treeView
			// 
			...
			this._treeView.Search.Mode = Quimron.WinUI.Controls.TreeListView.IncrementalSearchMode.Continuous;
			...
			this._treeView.ColumnClicked += new System.EventHandler<Quimron.WinUI.Controls.TreeListView.TreeColumnEventArgs>(this._treeView_ColumnClicked);
		...
		private Quimron.WinUI.Controls.TreeListView.TreeListView _treeView;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeStateIcon _icon;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox _name;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox _size;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeTextBox _date;
		private Quimron.WinUI.Controls.TreeListView.NodeControls.NodeCheckBox nodeCheckBox1;
		private Quimron.WinUI.Controls.TreeListView.TreeColumn treeColumn1;
		private Quimron.WinUI.Controls.TreeListView.TreeColumn treeColumn2;
		private Quimron.WinUI.Controls.TreeListView.TreeColumn treeColumn3;
	}
}
